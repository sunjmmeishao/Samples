...
//var  AliPayClient = require('alipay-webpay-sdk').default;
...
router.get('/', function(req, res, next) {
        ...
        var k = fs.readFileSync(accountSettings.APP_PRIVATE_KEY_PATH, 'utf8');
      //  console.log(k);
        ...
        let result = alipaySdk.exec('alipay.trade.create', params, options);
        console.log(result);
        let j =   [...params].map(([k, v]) => `${k}=${encodeURIComponent(v)}`).join('&') ;
      //  res.end();
    ...
    // http.get("https://openapi.alipay.com/gateway.do",function(data){
    //     var str="";
