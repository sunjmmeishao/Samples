...
file(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/Users/sunjm/Downloads/xlnt-master/samples/source/Debug/libxlntd.1.2.dylib")
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/Users/sunjm/Downloads/xlnt-master/samples/source/Release/libxlnt.1.2.dylib")
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/Users/sunjm/Downloads/xlnt-master/samples/source/MinSizeRel/libxlnt.1.2.dylib")
    if(EXISTS "$ENV{DESTDIR}/usr/local/lib/libxlnt.1.2.dylib" AND
       NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/libxlnt.1.2.dylib")
      execute_process(COMMAND "/usr/bin/install_name_tool"
        -id "libxlnt.1.2.dylib"
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/Users/sunjm/Downloads/xlnt-master/samples/source/RelWithDebInfo/libxlnt.1.2.dylib")
    if(EXISTS "$ENV{DESTDIR}/usr/local/lib/libxlnt.1.2.dylib" AND
       NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/libxlnt.1.2.dylib")
      execute_process(COMMAND "/usr/bin/install_name_tool"
        -id "libxlnt.1.2.dylib"
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/Users/sunjm/Downloads/xlnt-master/samples/source/Debug/libxlntd.dylib")
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/Users/sunjm/Downloads/xlnt-master/samples/source/Release/libxlnt.dylib")
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/Users/sunjm/Downloads/xlnt-master/samples/source/MinSizeRel/libxlnt.dylib")
    if(EXISTS "$ENV{DESTDIR}/usr/local/lib/libxlnt.dylib" AND
       NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/libxlnt.dylib")
      execute_process(COMMAND "/usr/bin/install_name_tool"
        -id "libxlnt.1.2.dylib"
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/Users/sunjm/Downloads/xlnt-master/samples/source/RelWithDebInfo/libxlnt.dylib")
    if(EXISTS "$ENV{DESTDIR}/usr/local/lib/libxlnt.dylib" AND
       NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/lib/libxlnt.dylib")
      execute_process(COMMAND "/usr/bin/install_name_tool"
        -id "libxlnt.1.2.dylib"
...
file(INSTALL DESTINATION "/usr/local/lib/pkgconfig" TYPE FILE FILES "/Users/sunjm/Downloads/xlnt-master/samples/source/xlnt.pc")
endif()

if(NOT CMAKE_INSTALL_LOCAL_ONLY)
  # Include the install script for each subdirectory.
  include("/Users/sunjm/Downloads/xlnt-master/samples/source/third-party/libstudxml/cmake_install.cmake")
